...
export const PLAYGROUND_ABI = [
  ...
  "function faucetInfo(address player) view returns (uint256 amount, uint256 cooldown, uint256 lastClaimAt, uint256 nextClaimAt, bool available)",
  ...
  "function depositPlayerFor(address player) payable",
